...
INSERT INTO `users` (`id`, `name`, `email`, `cogname`,`Cfiscale`, `indrizzo`, `cap`, `nazine`, `cita`, `provinza`) VALUES
(10, 'Anonymous ', 'Anonymous@gmail.com', 'Anonymous',' programmer', 'test', 'test', 'test', 'test','test' );
